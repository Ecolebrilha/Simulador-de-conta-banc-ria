...
function realizarLogin(nome, senha) {
    ...
    if (usuario && usuario.senha === senha) {
        if (usuario.perfil === "admin" && usuario.nome === "Fernando") {
...
cadastrarUsuario("Fernando", "senhaSegura", "admin", agencia1);
cadastrarUsuario("Maria", "senha123", "user", agencia2);
cadastrarUsuario("João", "senha456", "user", agencia3);